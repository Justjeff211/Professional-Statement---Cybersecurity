...
## About Me
I am a cybersecurity professional driven by a passion for protecting organizations and people from evolving digital threats. I do well in dynamic, high-pressure environments that demand investigative thinking, problem-solving and continuous learning. From my early experiences troubleshooting and repairing computers to system administration, networking and security tools, I have consistently demonstrated a natural aptitude for understanding systems and uncovering hidden patterns. These experiences have shaped my approach to cybersecurity, where curiosity, precision and adaptability are critical.

I am guided by a strong set of values, including a commitment to the confidentiality, integrity, and availability of data, ethical responsibility in handling sensitive information and continuous professional growth. These values inform every decision I make as a cybersecurity analyst, ensuring that my work aligns with legal, regulatory and organizational standards. By maintaining transparency, practicing ethical vigilance and prioritizing the protection of both organizational assets and people, I can contribute meaningfully to a security-conscious culture.
